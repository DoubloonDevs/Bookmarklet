...
function hud(parent) {
  this.pos = new Vector(parent.pos.x, parent.pos.y);
  this.cont_width = parent.width;
  this.cont_height = parent.height;
  ...
  this.display = function() {
    ...
    c.save();
    c.translate(this.pos.x, this.pos.y)
    c.fillRect(-this.cont_width, this.cont_height, parent.health, 5);
    c.fillStyle = 'white';
    c.font = '11pt Courier New';
    c.fillText(kills, -this.cont_width, -this.cont_height);
    c.restore();
  }
}
